 ...
 * @author José
 */
public class InfoCaducidadSemanal extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoCaducidadSemanal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
