 ...
 * @author jose
 */
public class InfoFacturacion extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoFacturacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
