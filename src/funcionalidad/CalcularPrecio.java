...
public class CalcularPrecio {
    public static double calcularPrecioTicket(String matricula, String identificador, String pin) {
        ...
        for (TicketVO ticket : listaDeTickets) {
            if (ticket.getHoraSalida() == null && ticket.getMatricula().equalsIgnoreCase(matricula) && Integer.toString(ticket.getCodPlaza()).equalsIgnoreCase(identificador) && ticket.getPin().equalsIgnoreCase(pin)) {
